...
CREATE TABLE IF NOT EXISTS CURSO (
	...
	GRADO_CURSO VARCHAR (20) CHARACTER SET utf8,

	LETRA_CURSO VARCHAR (1) CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS REL_CURSO_ASIGN (
	ID_CURSO INT,
...
CREATE TABLE IF NOT EXISTS RECOM (
	...
	ID_RECOM INT NOT NULL AUTO_INCREMENT PRIMARY KEY,

	NOMBRE_RECOM VARCHAR (200) CHARACTER SET utf8,

	COSTE_RECOM INT

)ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;

CREATE TABLE IF NOT EXISTS REL_ALUMN_RECOM (

	ID_RECOM INT,

	ID_ALUMN INT,

	FOREIGN KEY (ID_RECOM) REFERENCES RECOM (ID_RECOM),
