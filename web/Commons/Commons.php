...
// homeTeacher HEADER
	public static function teacherHeader(){
		...
		<header>
			<div class='content'>
				<a href='../homeTeacher/homeTeacher.php' id='logo'>
					<h1>L-EARN</h1>
				</a>
				<div id='menu-wrapper'>
					<div id='menu'>
						<nav>
							<ul>
								...
								<li><a href='../testTeacher/testTeacher.php'>Crear Test</a></li>
							</ul>
						</nav>
					</div>
					<div id='user'>
						<span>" . $_SESSION['teacherName'] . $_SESSION['teacherSurname'] ."</span>
						<img src='". $_SESSION['teacherImg'] . "' alt='Foto del profesor'>
					</div>
				</div>
