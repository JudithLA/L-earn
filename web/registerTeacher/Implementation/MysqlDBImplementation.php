...
class MysqlDBImplementation implements DBInterface {
    ...
    private $port;
     ...
     function __construct($DBhost = "127.0.0.1", $port = "8889", $DBname = "DBLEARN", $user = "root", $pass = "root") {
        $this->DBhost = $DBhost;
        $this->DBname = $DBname;
        $this->user = $user;
        $this->pass = $pass;
    ...
    public function connect() {
        ...
        $this->conn = mysqli_connect($this->DBhost, $this->user, $this->pass, $this->DBname, $this->port);
